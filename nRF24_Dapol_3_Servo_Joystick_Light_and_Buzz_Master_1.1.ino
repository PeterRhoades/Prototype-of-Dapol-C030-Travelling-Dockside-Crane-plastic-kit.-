...
Peter Rhoades:
Wednesday 02/03/22:
nRF24 Dapol 3 Servo Joystick Light and Buzz Master®
Folder nRF24_Dapol_3_Servo_Joystick_Light_and_Buzz_Master_1.1:
Saturday 26/03/22: Working on UNO"


nRF Tranciver Uno & Nano:
  1 = GRN  Black   
  2 = 3.3v Red
  3 = CE   Pin 7  Blue
  4 = CSN  Pin 8  Green
